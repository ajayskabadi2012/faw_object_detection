...
Easy way: run [this Colab Notebook](https://colab.research.google.com/github/ajayskabadi2012/faw_object_detection/blob/master/tensorflow_object_detection_training_colab.ipynb).
